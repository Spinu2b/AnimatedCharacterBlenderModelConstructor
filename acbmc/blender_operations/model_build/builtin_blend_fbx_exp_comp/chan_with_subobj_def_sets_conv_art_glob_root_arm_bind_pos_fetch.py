from acbmc.blender_operations.model_build.builtin_blend_fbx_exp_comp.armature.uni_ani_clip_arm_tree_hier_with_def_sets_fetch import UnifiedAnimationClipArmatureTreeHierarchiesWithDeformSetsFetcher
...
class ChannelsWithSubobjectsDeformSetsConvenientArtistGlobalRootedArmatureBindPoseFetcher:
    def derive_armature_bind_pose_model(
        animation_clips: Dict[int, AnimationClip],
        ...
        for animation_clip_id in animation_clips:
            animation_clip_obj = animation_clips[animation_clip_id]  # type: AnimationClip
